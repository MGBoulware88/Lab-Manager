    ...
    return (
        <div className="d-flex m-auto">
            ...
            <section className="d-flex flex-column" style={{ width: "100%" }}>
                <TopNav />
                <Container className="d-flex row gap-2" style={{ width: "auto" }}>
                    ...
                    <Card className={`col-3 ${styles.tiles}`}>
                        ...
                        <a href="/accounts/new" className={`${styles.tileLinks}`}>Add Account <FontAwesomeIcon icon={faShareFromSquare} /></a>
                    </Card>
                    <Card className={`col-3 ${styles.tiles}`}>
                        <FontAwesomeIcon icon={faHospitalUser} className={`mx-3 ${styles.tileIcons}`} />
                        <a href="/accounts/providers/new" className={`${styles.tileLinks}`}>Add Provider <FontAwesomeIcon icon={faShareFromSquare} /></a>
                    </Card>
                    <Card className={`col-3 ${styles.tiles}`}>
                        <h3>New Orders - 25</h3>
